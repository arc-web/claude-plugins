...
export function execSafe(cmd: string, args: string[], cwd: string): string | null {
  try {
...
export function findPkgManager(root: string): string | null {
...
export function toSeverity(raw: unknown): FindingSeverity {
...
export function recommendForSize(
  lines: number,
  threshold: number,
  kind: "file" | "function",
...
export function analyzeFileOrganization(
  store: GraphStore,
  runId: string,
  repoRoot: string,
): number {
...
export function analyzeSecurityCLI(
  store: GraphStore,
  runId: string,
  repoRoot: string,
): number {
