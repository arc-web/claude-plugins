...
function buildScriptData(nodes: VisNode[], catsPresent: string[]): string {
...
function buildScriptControls(): string {
  return `
...
function buildScriptGraphLogic(): string {
  return `
...
function buildScriptDetailPanel(): string {
  return `
...
function buildScriptRender(): string {
  return `
function render(){
...
function buildScript(nodes: VisNode[], catsPresent: string[]): string {
  return [
