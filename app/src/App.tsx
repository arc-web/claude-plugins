...
export default function App() {
  ...
  if (!data) {
    return (
      <div className="flex items-center justify-center h-screen bg-background text-muted-foreground text-sm">
        No graph data available. Run /build-graph first.
      </div>
    );
  }
  ...
  return (
    <TooltipProvider delay={300}>
      <div className="flex flex-col h-screen bg-background">
        {/* Header */}
        <div className="flex items-center h-10 px-4 border-b border-border shrink-0 gap-3">
          ...
          <input
            ...
            className="ml-auto h-6 w-44 px-2.5 rounded-md text-[11px] border border-border bg-muted text-foreground outline-none placeholder:text-muted-foreground/60 focus:border-ring"
          />
        </div>
